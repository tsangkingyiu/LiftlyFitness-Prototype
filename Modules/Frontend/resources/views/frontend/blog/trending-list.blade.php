<x-frontend-layout :assets="$assets ?? []">
            ...
            <div class="container">
                <div class="d-flex align-items-center position-absolute top-0 bottom-0 banner-content ps-sm-0 ps-3">
                    <div>
                        ...
                        <span> / {{ __('frontend::message.trending_blogs') }}</span>
    ...
    <main class="section-color">
        <section>
            <div class="container" id="trending-blog-section">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between">
                            <h6 class="font-h6 mb-4 mt-4">{{ __('frontend::message.trending_blogs') }}</h6>
                        </div>
                    </div>
                </div>
                <div class="row" id="load_more" data-route={{ route('trending.blog.list') }}>
                    @foreach ($data['trending_blog']->isNotEmpty() ? $data['trending_blog'] : [(object) ['id' => '', 'title' => $data['dummy_title'],'created_at' => 'N/A', 'category_ids' => []]] as $trending_blog)
